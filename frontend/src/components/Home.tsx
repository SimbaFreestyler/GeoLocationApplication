    ...
    <div>
        <div className="main-container">
            ...
            <p className="text description1">
                GeoApp to aplikacja, która pozwala zarządzać danymi lokalizatorów, pojazdów i kierowców w jednym
                miejscu. Chcesz sprawdzić, jaką trasę przebył Twój pojazd lub kierowca?
